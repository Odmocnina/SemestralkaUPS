...
public class Kamen extends AbstractVolba implements IVolba {
    ...
    public void nakresliVolbuO(Graphics2D g, int x, int y, int pocetSloupcu, int pocetRadku) {
        ...
        g.drawString("Kámen", (float)(realneX + mensiStrana / 4), (float)(relaneY + mensiStrana / 2));
    ...
    public void nakresliVolbu(Graphics2D g, int x, int y, int pocetSloupcu, int pocetRadku) {
        super.nakresliVolbuObecne(g, "Kámen", x, y, pocetSloupcu, pocetRadku);
