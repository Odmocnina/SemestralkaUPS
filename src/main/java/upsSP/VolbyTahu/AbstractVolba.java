...
public class AbstractVolba {
    ...
    public void nakresliVolbuObecne(Graphics2D g, String nazev, int x, int y, int pocetSloupcu, int pocetRadku) {
        // Načtení obrázku
        ...
        g.drawString(nazev, (float)(realneX + mensiStrana / 4), (float)(relaneY + mensiStrana / 2));
    ...
    public boolean jeZvoleno(double x, double y) {
        System.out.println("V je zvoleno" + realneX + " " + relaneY + " " + mensiStrana);
